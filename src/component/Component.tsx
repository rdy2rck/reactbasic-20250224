...
// - React16.8 버전부터 Hook 이라는 함수로 컴포넌트의 생명주기를 다룰 수 있게 되면서 클래스로 복잡하게 생명 주기를 다룰 필요가 없어짐
...
// 2. function 컴포넌트
// - 함수로 컴포넌트를 작성
// - 반드시 첫 글자를 대문자로 작성하는 UpperCamelCase를 사용해야 컴포넌트로 인식
